...
export function Contact() {
    ...
    return (
        <section id="contact" className="py-8 md:py-20 w-full max-w-[min(100%,1200px)] mx-auto px-4 relative mb-10 md:mb-20">
            ...
            >
                ...
                <div className="relative bg-[#08080a] border border-white/[0.07] rounded-2xl overflow-hidden shadow-xl flex flex-col md:flex-row">
                    ...
                    <div className="md:w-[42%] p-5 sm:p-8 md:p-9 flex flex-col justify-between relative overflow-hidden backdrop-blur-sm">
                        {/* Futuristic Header */}
                        <div className="flex items-center gap-2 text-[10px] sm:text-xs font-mono text-violet-400/70 mb-4 md:mb-8 tracking-[0.2em] uppercase">
                        ...
                        <div className="relative z-10">
                            ...
                            <h2 className="text-[1.5rem] sm:text-3xl md:text-[1.85rem] lg:text-[2.1rem] font-extrabold text-white leading-[1.12] mb-3 md:mb-5 tracking-tight">
                            ...
                            <p className="text-zinc-400 text-xs sm:text-sm md:text-[0.95rem] leading-relaxed border-l border-violet-500/40 pl-3 md:pl-4 py-0.5 md:py-1 max-w-sm">
                                I turn complex problems into elegant, scalable code—ready when you are to ship the next idea.
                            </p>
                        </div>

                        {/* Connection Stats / Info */}
                        <div className="grid grid-cols-2 gap-2 mt-4 md:mt-10">
                            <a
                                href="https://mail.google.com/mail/?view=cm&fs=1&to=anilgowda3103@gmail.com"
                                target="_blank"
                                rel="noreferrer"
                                className="p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.07] hover:border-violet-500/20 transition-colors group/item text-left"
                            >
                                <div className="mb-1 text-violet-400">
                                    <Icons.mail className="w-4 h-4 group-hover/item:scale-110 transition-transform" />
                                </div>
                                <div className="text-[9px] text-zinc-500 font-mono mb-0.5">EMAIL_LINK</div>
                                <div className="text-[11px] font-medium text-zinc-300 truncate">anilgowda3103@...</div>
                            </a>
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="p-2.5 rounded-xl bg-white/[0.04] border border-white/[0.06] hover:bg-white/[0.07] hover:border-indigo-500/20 transition-colors group/item text-left"
                            >
                                <div className="mb-1 text-indigo-400">
                                    <Icons.linkedin className="w-4 h-4 group-hover/item:scale-110 transition-transform" />
                                </div>
                                <div className="text-[9px] text-zinc-500 font-mono mb-0.5">PROFILE_ID</div>
                                <div className="text-[11px] font-medium text-zinc-300">Connect</div>
                            </a>
                        </div>
                    </div>

                    {/* Right Panel: The Form Interface */}
                    <div className="md:w-[58%] p-5 sm:p-8 md:p-9 bg-white/[0.015] relative border-t md:border-t-0 md:border-l border-white/[0.06]">
                        ...
                        <form
                            ...
                            className="relative z-10 space-y-4 md:space-y-7"
                        >
                            <div className="group/input relative">
                                <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-0.5 md:mb-1.5 block group-focus-within/input:text-violet-400 transition-colors">
                                ...
                                <input
                                    ...
                                    className="w-full bg-transparent border-b border-white/10 py-1.5 md:py-3 text-sm md:text-lg text-white placeholder:text-zinc-600 focus:outline-none focus:border-violet-500 transition-all font-light disabled:opacity-50"
                                />
                            </div>

                            <div className="group/input relative">
                                <label className="text-[10px] font-mono text-zinc-500 uppercase tracking-wider mb-0.5 md:mb-1.5 block group-focus-within/input:text-violet-400 transition-colors">
                                    // 02. Communication Channel (Email)
                                </label>
                                <input
                                    type="email"
                                    name="email"
                            ...
                            <div className="group/input relative">
                                ...
                                <textarea
                                    ...
                                    className={`w-full bg-transparent border-b py-1.5 md:py-3 text-sm md:text-lg text-white placeholder:text-zinc-600 focus:outline-none transition-all font-light resize-none disabled:opacity-50 ${hasLinkError ? 'border-red-500' : 'border-white/10 focus:border-violet-500'}`}
                                />
                                {hasLinkError && (
                            ...
                            <div className="pt-2 md:pt-4">
                                <Button
                                    ...
                                    className={`relative overflow-hidden group/btn text-black rounded-lg w-full h-11 md:h-14 text-sm md:text-base font-bold tracking-wide transition-all ${hasLinkError
                                ...
                                <div className="mt-3 md:mt-4 flex items-center justify-center gap-2 text-[10px] text-zinc-600 font-mono tracking-widest uppercase opacity-60">
                                    <Icons.shield className="w-3 h-3" />
                        ...
                        >
                            ...
                            <div className="flex flex-col items-center text-center relative z-10">
                                ...
                                <p className="text-zinc-400 mb-8 leading-relaxed">
                                    Your message has been successfully sent. I will review it and get back to you shortly.
                                </p>
